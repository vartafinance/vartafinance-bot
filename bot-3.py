...
ВАЖЛИВО ПРО АКТУАЛЬНІСТЬ: Зараз 2026 рік. Всі новини, реформи, зміни в законодавстві — подавай як актуальні події 2026 року. Якщо згадуєш звіти або статистику — це дані за 2025 рік або початок 2026. Пенсійна реформа, зміни ЄСВ, трудове законодавство — все що відбувається зараз у 2026 році.
...
- Дані про страховий стаж, трудову книжку і пенсію — завжди в особистому кабінеті ПФУ cabinet.pfu.gov.ua, НЕ в Дії
...
ВАЖЛИВО ПРО АКТУАЛЬНІСТЬ: Зараз 2026 рік. Якщо згадуєш фінансові звіти — це річний звіт за 2025 рік. Рейтинги і показники надійності — дані 2025-2026 років. НБУ нагляд і регуляторні вимоги — актуальні на 2026 рік.
...
ПРАВИЛА:
- Пиши ТІЛЬКИ українською мовою
- Теми: рейтинги надійності, річний звіт за 2025, фінансові результати 2025, історія компанії, австрійський капітал, стабільність, НБУ нагляд 2026
...
ВАЖЛИВО ПРО АКТУАЛЬНІСТЬ: Зараз 2026 рік. Всі цифри, закони, реалії — актуальні для 2026 року. Якщо згадуєш пенсійну реформу або зміни в законодавстві — це відбувається зараз у 2026. Вартість лікування, розмір пенсій, мінімальні зарплати — дані 2025-2026 років.
...
- Один конкретний закон України з номером актуальний на 2026 рік
- Емодзі 2-4 штуки
- НЕ використовуй символи: _ [ ] ( ) ~ > # + - = | { } . ! у тексті"""
...
INFO_TOPICS = [
    {"name": "pension_reform_1",
     "hook": "Пенсійна реформа 2026 — що реально змінилось для українців цього року.",
     "text": "Напиши пост про пенсійну реформу в Україні у 2026 році. Закон 1058-IV про загальнообовязкове державне пенсійне страхування та зміни 2026 року. Що змінилось для майбутніх пенсіонерів, нові вимоги до стажу і розрахунку пенсії."},
    {"name": "pension_deficit",
     "hook": "ПФУ дефіцитний і у 2026. Бюджет залатали субвенцією — але проблему не вирішили.",
     "text": "Напиши пост про дефіцит Пенсійного фонду України у 2026 році. Закон 1058-IV. Бюджет ПФУ на 2026 рік — цифри і субвенція від держави. Чому солідарна система не може самостійно виплачувати пенсії."},
    ...
    {"name": "trudova_knyzhka",
     ...
     "text": "Напиши пост про трудову книжку в Україні. КЗпП статті 48-49 та Закон 1217-IX про е-трудову. Що діє зараз, чи потрібна паперова книжка і як перевірити стаж в особистому кабінеті ПФУ на cabinet.pfu.gov.ua."},
    {"name": "etrudova",
     "hook": "Електронна трудова книжка — як перевірити чи всі роки там є.",
     "text": "Напиши пост про е-трудову книжку та портал ПФУ. Закон 1217-IX від 2021. Як перевірити стаж через особистий кабінет на сайті ПФУ cabinet.pfu.gov.ua і що робити якщо знайшов помилки."},
    {"name": "moriak_pension",
    ...
    {"name": "economy_war",
     "hook": "Трудове законодавство України у 2026 — що змінилось за роки воєнного стану.",
     "text": "Напиши пост про актуальні зміни в трудовому законодавстві України у 2026 році в умовах воєнного стану. Закон 2136-IX та його зміни у 2025-2026 роках. Що діє зараз для працівників і роботодавців, які норми КЗпП призупинені."},
    {"name": "minimal_wage",
     "hook": "Мінімальна зарплата у 2026 зросла до 8000 грн. А мінімальна пенсія — значно менша.",
     "text": "Напиши пост про мінімальну зарплату і мінімальну пенсію в Україні у 2026 році. КЗпП стаття 95 та Закон 1058-IV. Актуальні розміри мінімалки і пенсії у 2026, чому розрив між ними зростає."},
    {"name": "women_stazh",
...
GRAWE_TOPICS = [
    {"name": "grawe_history",
     ...
     "text": "Напиши короткий пост про історію страхової групи GRAWE. Заснована в 1828 році в Граці Австрія. В Україні з 1998 року — спочатку як СК ІНПРО потім ГРАВЕ УКРАЇНА. Пережила дві світові війни всі кризи і продовжує працювати у 2026 році."},
    {"name": "grawe_nbu_rating",
     "hook": "НБУ вніс ГРАВЕ Україна до переліку значимих страховиків у 2026 році. Таких лише 13 в країні.",
     "text": "Напиши короткий пост про включення ГРАВЕ УКРАЇНА Страхування життя до переліку значимих страховиків НБУ станом на 1 січня 2026 року. Положення НБУ 194. Що означає цей статус — посилений нагляд вимоги до капіталу і додаткові гарантії виплат для клієнтів."},
    {"name": "grawe_report_2025",
     "hook": "ГРАВЕ Україна виплатила понад 400 мільйонів гривень клієнтам у 2025 році.",
     "text": "Напиши короткий пост про річний звіт ГРАВЕ УКРАЇНА за 2025 рік. 211 млн грн виплати тим хто завершив накопичувальні програми. 114 млн грн регулярні ануїтетні виплати як додаткова пенсія. 39 млн грн медичні випадки. Понад 8000 нових договорів за рік. Закон 85/96-ВР."},
    {"name": "grawe_sep",
     "hook": "СЕП від ГРАВЕ — це не просто страховка. Це твоя приватна пенсія з гарантованою ставкою.",
     "text": "Напиши короткий пост про програму СЕП від ГРАВЕ УКРАЇНА. Страхова Економічна Програма — це накопичення капіталу плюс страховий захист в одному продукті. Гарантована ставка до 4 відсотків річних плюс щорічні бонуси від інвестиційного доходу. При досягненні пенсійного віку клієнт отримує всю суму з бонусами. Закон 85/96-ВР та стаття 166.3.5 ПКУ — податкова знижка."},
    {"name": "grawe_invest_plan",
     "hook": "ІНВЕСТ ПЛАН від ГРАВЕ — накопичуєш поступово а отримуєш значний капітал.",
     "text": "Напиши короткий пост про програму ІНВЕСТ ПЛАН від ГРАВЕ УКРАЇНА. Програма допомагає протягом тривалого часу накопичити капітал для значних майбутніх витрат або додаткової пенсії. Гарантована ставка до 4 відсотків річних. Мінімум 85 відсотків інвестиційного доходу повертається клієнтам у вигляді бонусів. Закон 85/96-ВР та стаття 166.3.5 ПКУ."},
    {"name": "grawe_pidtrymka",
     "hook": "ГРАВЕ Підтримка — захист від інсульту інфаркту і онкології. Три найстрашніші діагнози в одному полісі.",
     "text": "Напиши короткий пост про програму ГРАВЕ Підтримка 3 від ГРАВЕ УКРАЇНА. Захист на випадок діагностування трьох критичних хвороб: інсульту інфаркту та злоякісного новоутворення. При першому діагнозі компанія виплачує страхову суму — гроші на лікування без очікування. Програма поєднує накопичення і захист здоровя. Закон 85/96-ВР."},
    {"name": "grawe_junior",
     "hook": "ЮНІОР ЕКСТРА від ГРАВЕ — якщо з тобою щось станеться ГРАВЕ продовжить платити за дитину замість тебе.",
     "text": "Напиши короткий пост про програму ЮНІОР ЕКСТРА від ГРАВЕ УКРАЇНА. Класична європейська програма де застраховані двоє — батько або мати і дитина. Якщо годувальник іде з життя ГРАВЕ перебирає на себе всі подальші внески і дитина все одно отримує повну суму з бонусами. Додатковий захист від нещасного випадку. Закон 85/96-ВР."},
    {"name": "grawe_gold",
     "hook": "ГРАВЕ ГОЛД — накопичуєш капітал до 85 років і залишаєш спадок дітям та онукам.",
     "text": "Напиши короткий пост про програму ГРАВЕ ГОЛД. Унікальна програма для тих хто хоче створити значний капітал і залишити спадок близьким. Страхова сума виплачується при досягненні 85 років або спадкоємцям у разі смерті. Без медичного обстеження до певного ліміту суми. Закон 85/96-ВР."},
    {"name": "grawe_metlife",
     "hook": "MetLife пішла з України. ГРАВЕ залишилась. 27 років — жодної зміни власника.",
     "text": "Напиши короткий пост про те що PZU викупила MetLife Ukraine — консолідація ринку страхування у 2025 році. На цьому фоні ГРАВЕ УКРАЇНА 27 років без жодної зміни власника — австрійський концерн GRAWE Group. Закон 85/96-ВР."},
    {"name": "grawe_austria",
     "hook": "Австрійський капітал в українській страховці — це юридичний факт а не маркетинг.",
     "text": "Напиши короткий пост про міжнародну структуру GRAWE Group. Материнська компанія Grazer Wechselseitige Versicherung AG заснована в 1828 році в Австрії — один з найстаріших страховиків Європи. Концерн ніколи не припиняв роботи навіть під час двох світових воєн. Що це означає для українського клієнта у 2026 році. Закон 85/96-ВР."},
    {"name": "grawe_stability",
     "hook": "ГРАВЕ Україна пережила 1998 2008 2014 2022 і продовжує платити у 2026. Пять криз — нуль банкрутств.",
     "text": "Напиши короткий пост про фінансову стабільність ГРАВЕ УКРАЇНА через призму економічних криз аж до 2026 року. Закон 85/96-ВР та актуальні вимоги НБУ до резервів страхових компаній у 2026. Порівняй кількість страхових компаній на ринку у 2000 і у 2026 — ринок скоротився а ГРАВЕ залишилась."},
    {"name": "grawe_license",
     "hook": "Ліцензія НБУ на страхування життя — це не формальність. На всьому ринку її мають одиниці.",
     "text": "Напиши короткий пост про вимоги до ліцензії на страхування життя в Україні у 2026 році. Закон 85/96-ВР та регуляторні вимоги НБУ. Чому це серйозна вимога і що вона гарантує клієнту. ГРАВЕ УКРАЇНА Страхування життя має ліцензію з 1998 року."},
    {"name": "grawe_tax",
     "hook": "ГРАВЕ і податкова знижка — держава повертає до 18 відсотків від суми твоїх внесків. Щороку.",
     "text": "Напиши короткий пост про податкову знижку на страхування життя від ГРАВЕ УКРАЇНА. Стаття 166.3.5 Податкового кодексу України. Клієнти програм СЕП ІНВЕСТ ПЛАН ГРАВЕ КЛАСІК та інших мають право щороку повертати частину сплачених внесків через податкову декларацію. Конкретний приклад розрахунку для 2026 року."},
    {"name": "grawe_payments_war",
     "hook": "Під час бомбардувань ГРАВЕ продовжувала виплачувати кошти клієнтам. Факти 2022-2025 років.",
     "text": "Напиши короткий пост про виплати ГРАВЕ УКРАЇНА в умовах воєнного стану 2022-2025 років. Закон 85/96-ВР. Страхова компанія не призупиняла виплати клієнтам навіть під час активних бойових дій. Австрійський капітал і резерви НБУ як гарантія. Що це означає для клієнтів у 2026 році."},
]
...
POLL_TOPICS = [
    {"question": "Чи знаєте скільки у вас страхового стажу?",
     "options": ["Так, знаю точно", "Приблизно знаю", "Не знаю", "Піду перевірю на сайті ПФУ"]},
...
USED_INFO_FILE = "/data/used_info.txt"
USED_GRAWE_FILE = "/data/used_grawe.txt"
USED_SALES_FILE = "/data/used_sales.txt"
USED_POLL_FILE = "/data/used_poll.txt"
...
PENDING_DIR = "/data/varta_pending"
...
def save_pending(msg_id, data):
    ...
    # photo_file_id зберігається в meta автоматично

    # Зберігаємо метадані
    with open(PENDING_DIR + "/" + msg_id + ".meta", "wb") as f:
        _pickle.dump(meta, f)

    # Зберігаємо зображення (байти) якщо є
    if img_bytes:
        with open(PENDING_DIR + "/" + msg_id + ".img", "wb") as f:
            f.write(img_bytes)
        print("Pending saved: " + msg_id + " (image bytes: " + str(len(img_bytes)) + ")")
    elif meta.get("photo_file_id"):
        print("Pending saved: " + msg_id + " (photo_file_id: " + meta["photo_file_id"] + ")")
    else:
        print("Pending saved: " + msg_id + " (no image)")
...
async def handle_forward(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("forward_") or data.startswith("forwardclean_"):
        ...
        # query.message.text — для текстових постів
        # query.message.caption — для постів де текст є підписом до фото
        current_text = query.message.text or query.message.caption or post_data["text"]
        ...
        if img_bytes:
            # Зображення збережене як байти (пости від бота)
            print("Forward image_bytes: " + str(len(img_bytes)) + " bytes")
            try:
                import io as _io
                buf = _io.BytesIO(img_bytes)
                buf.seek(0)
                await bot.send_photo(chat_id=CHANNEL_ID, photo=buf)
                print("Image forwarded OK (from bytes)")
            except Exception as img_err:
                print("Image forward error: " + repr(img_err))
        elif photo_file_id:
            # Зображення з ручного поста — використовуємо file_id
            print("Forward photo by file_id: " + photo_file_id)
            try:
                await bot.send_photo(chat_id=CHANNEL_ID, photo=photo_file_id)
                print("Image forwarded OK (from file_id)")
            except Exception as img_err:
                print("Image forward error (file_id): " + repr(img_err))
        else:
            print("No image to forward")
...
async def fetch_minsoc_news():
    return await fetch_channel_news("MinSocUA", PENSION_KEYWORDS, "/app/last_minsoc.txt")

async def fetch_grawe_news():
    return await fetch_channel_news("graweinukraine", GRAWE_KEYWORDS, "/app/last_grawe.txt")
...
async def fetch_pfu_news():
    try:
        ...
        if not titles:
            return None
        last_url = get_last_id("/app/last_pfu.txt")
        for url, title in titles[:10]:
            ...
            if any(kw in title.lower() for kw in PENSION_KEYWORDS):
                save_last_id("/app/last_pfu.txt", url)
                ...
                return text
        if titles:
            save_last_id("/app/last_pfu.txt", titles[0][0])
        return None
    except Exception as e:
...
async def handle_test_channel_post(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Отримуємо текст — з підпису фото або з тексту
    text = msg.caption or msg.text or ""

    # Отримуємо file_id фото якщо є
    photo_file_id = None
    if msg.photo:
        # Беремо найбільшу версію фото
        photo_file_id = msg.photo[-1].file_id
        print("Manual post has photo: " + photo_file_id)
    elif msg.document and msg.document.mime_type and msg.document.mime_type.startswith("image"):
        photo_file_id = msg.document.file_id
        print("Manual post has document image: " + photo_file_id)

    # Якщо немає ні тексту ні фото — пропускаємо
    if not text and not photo_file_id:
        return

    # Якщо тільки фото без тексту — також додаємо кнопки
    ...
    try:
        ...
        save_pending(msg_id, {
            ...
            "with_button": True,
            "topic_name": "manual",
            "image_bytes": None,          # байтів немає — використовуємо file_id
            "photo_file_id": photo_file_id,  # file_id з Telegram
            "poll_question": None,
            "poll_options": None,
        })
        print("Buttons added to manual post: " + msg_id + (" +photo" if photo_file_id else " text only"))
    except Exception as e:
