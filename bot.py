...
TOPICS = [
    ...
    {"name": "pension_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a worried elderly Slavic Ukrainian woman looking at utility bills at kitchen table, warm natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "pension_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian man in his 50s looking worried at financial documents, home setting, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "pension_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a tired Slavic Ukrainian woman in her 60s still working at office desk, natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "pension_4", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a happy Slavic retired couple traveling in Europe, positive mood, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "pension_5", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman in her 40s planning finances with calculator at home, focused expression, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "stazh_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a surprised Slavic Ukrainian woman looking at pension documents, home office, natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "stazh_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a young Slavic Ukrainian woman working on laptop abroad, modern setting, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "stazh_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a worried Slavic Ukrainian man in his 50s checking documents, home setting, natural window light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "stazh_4", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman checking documents on smartphone, modern bright apartment, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "stazh_5", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman smiling while using Diia app on smartphone, bright modern home, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "life_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a happy Slavic Ukrainian family of four in sunny park, genuine smiles, golden hour light, candid documentary photography, Sony A7III 85mm, no text",
    ...
    {"name": "life_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a confident Slavic Ukrainian woman signing financial documents at office, natural light, professional setting, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "life_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a young Slavic Ukrainian couple in their 30s discussing finances at home, warm natural light, candid documentary style, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "life_4", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a happy Slavic Ukrainian woman receiving good news on smartphone, bright home setting, genuine smile, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "life_5", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a caring Slavic Ukrainian family together at home, warm atmosphere, genuine connection, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "fop_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian self-employed woman working from home looking tired, natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "fop_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a young Slavic Ukrainian IT professional working at modern desk, thoughtful expression, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "fop_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a worried Slavic Ukrainian entrepreneur looking at business documents, home office, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "moriak_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian sailor in uniform with family at home, warm reunion atmosphere, natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "moriak_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman with children waiting at home, warm family atmosphere, natural window light, candid documentary style, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "moriak_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman at home managing household, thoughtful expression, warm natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "youth_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a young Slavic Ukrainian man in his 20s smiling and planning future, bright modern setting, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "youth_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a young Slavic Ukrainian woman at her first job, professional office, excited expression, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "women_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman in her 50s looking thoughtfully out window, warm natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "women_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a happy Slavic Ukrainian mother with baby at home, warm cozy atmosphere, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "women_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, an active happy Slavic Ukrainian elderly woman enjoying retirement, traveling or hobby, natural light, positive mood, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "war_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a calm confident Slavic Ukrainian family at home feeling secure, warm atmosphere, natural light, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "war_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a relieved Slavic Ukrainian woman receiving good financial news, home setting, warm natural light, genuine smile, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "war_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a thoughtful Slavic Ukrainian couple planning finances at home, calm atmosphere, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "psych_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a Slavic Ukrainian woman making a positive decision, confident expression, bright home setting, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "psych_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a happy Slavic Ukrainian woman planning trip on laptop, warm home atmosphere, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "psych_3", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a free happy Slavic Ukrainian woman in her 50s enjoying life outdoors, confident and joyful, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "psych_4", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a motivated Slavic Ukrainian woman making a financial decision, determined expression, bright modern home, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "grawe_1", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a confident Slavic Ukrainian financial consultant woman at professional office, warm atmosphere, clean modern design, no text, no watermark, vibrant colors",
    ...
    {"name": "grawe_2", "day": [0,1,2,3,4],
     ...
     "image_prompt": "Flat vector illustration style, colorful, Ukrainian financial theme, a secure happy Slavic Ukrainian family at home, protected and confident feeling, warm natural light, documentary style, clean modern design, no text, no watermark, vibrant colors",
...
def create_varta_image(headline, photo_url=None):
    ...
    overlay = Image.new("RGBA", (W, 320), (13, 43, 92, 215))
    ...
    draw.rectangle([60, 54, W-60, 59], fill=GOLD)

    lines = wrap_text(draw, headline, ft, W-80)
    total_h = len(lines) * 78
    start_y = 68 + max(0, (300 - 68 - total_h) // 2)
    for i, ln in enumerate(lines):
        lw = draw.textbbox((0,0), ln, font=ft)[2]
        draw.text(((W-lw)//2+2, start_y+i*78+2), ln, font=ft, fill=(0,20,80))
        draw.text(((W-lw)//2, start_y+i*78), ln, font=ft, fill=WHITE)

    overlay2 = Image.new("RGBA", (W, 55), (13, 43, 92, 200))
    img.paste(overlay2, (0, H-55), overlay2)
    draw = ImageDraw.Draw(img)
    draw.rectangle([0, H-55, W, H-50], fill=GOLD)
    ch = "@VartaFinance"
    chw = draw.textbbox((0,0), ch, font=fb)[2]
    draw.text(((W-chw)//2, H-40), ch, font=fb, fill=GOLD)
