...
ВАЖЛИВО: Коли згадуєш накопичення — завжди пиши про ЩОРІЧНІ відкладення, не щомісячні. Для прикладу використовуй суму 25000 грн на рік — як ілюстрацію того скільки можна відкласти за рік.
