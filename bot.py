...
GRAWE_TOPICS = [
    ...
    {"name": "grawe_nbu_rating",
     "hook": "НБУ вніс GRAWE Ukraine до переліку значимих страховиків станом на 2026 рік. Таких лише 13 в країні.",
     "text": "Напиши короткий пост про включення GRAWE Ukraine до переліку значимих страховиків НБУ станом на 1 січня 2026 року. Положення НБУ 194. Що означає цей статус для клієнта у 2026 — посилений нагляд, вимоги до капіталу і додаткові гарантії виплат."},
    {"name": "grawe_report",
     "hook": "Річний звіт GRAWE Ukraine за 2025 рік: виплати тривають навіть в умовах війни.",
     "text": "Напиши короткий пост про річний фінансовий звіт GRAWE Ukraine за 2025 рік. Закон 85/96-ВР та вимоги НБУ до платоспроможності страховиків у 2026 році. Ключові показники стабільності та обсяги виплат клієнтам."},
    {"name": "grawe_metlife",
    ...
    {"name": "grawe_stability",
     "hook": "GRAWE Ukraine пережила 1998, 2008, 2014, 2022 і продовжує працювати у 2026. Пять криз — нуль банкрутств.",
     "text": "Напиши короткий пост про стабільність GRAWE Ukraine через призму економічних криз аж до 2026 року. Закон 85/96-ВР та актуальні вимоги НБУ до резервів страхових компаній у 2026. Факти, цифри і порівняння з ринком."},
    {"name": "grawe_license",
