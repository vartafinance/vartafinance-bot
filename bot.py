...
TOPICS = [
    {"name": "pension", "day": [0],
     ...
     "image_prompt": "Happy smiling retired couple enjoying life, sitting in bright cozy home, warm sunlight, positive and hopeful mood, realistic photo, no text no signs",
    ...
    {"name": "stazh", "day": [2],
     ...
     "image_prompt": "Confident professional person working at modern desk, career growth concept, bright office, positive atmosphere, realistic photo, no text no signs",
    ...
    {"name": "solidarna", "day": [2],
     ...
     "image_prompt": "Thoughtful middle aged woman planning finances at home, calculator and notebook, natural light, realistic photo, no text no signs",
    ...
    {"name": "etrudova", "day": [2],
     ...
     "image_prompt": "Person smiling using smartphone app, modern bright setting, checking documents digitally, Ukraine, no text no signs",
    ...
    {"name": "dms", "day": [4],
     ...
     "image_prompt": "Happy healthy family with doctor in bright clinic, care and warmth, positive realistic photo, no text no signs",
    ...
    {"name": "life", "day": [4],
     ...
     "image_prompt": "Happy family outdoors in park, parents and children, sunny day, love and security concept, realistic photo, no text no signs",
    ...
    {"name": "kzpp", "day": [0],
     ...
     "image_prompt": "Professional woman reading documents at desk, modern office, focused and confident, realistic photo, no text no signs",
...
def create_varta_image(photo_url=None):
    ...
    # Dark overlay on top
    overlay = Image.new("RGBA", (W, TOP_H), (13, 43, 92, 230))
    ...
    draw.text(((W-bw)//2, 16), brand, font=fb, fill=GOLD)
